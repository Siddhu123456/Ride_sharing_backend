...
from app.services.trip.fare_service import calculate_fare
from app.services.trip.tenant_city_service import get_tenants_operating_in_city
from app.services.trip.driver_availability_service import (
